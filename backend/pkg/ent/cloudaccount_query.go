...
func (_q *CloudAccountQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *CloudAccountQuery) FirstIDX(ctx context.Context) string {
...
func (_q *CloudAccountQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *CloudAccountQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *CloudAccountQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *CloudAccountQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(cloudaccount.FieldName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *CloudAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(cloudaccount.Table, cloudaccount.Columns, sqlgraph.NewFieldSpec(cloudaccount.FieldID, field.TypeString))
	_spec.From = _q.sql
