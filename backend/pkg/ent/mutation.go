...
func (m *DomainMutation) SetBlockedReason(s string) {
	m.blocked_reason = &s
}

// BlockedReason returns the value of the "blocked_reason" field in the mutation.
func (m *DomainMutation) BlockedReason() (r string, exists bool) {
	v := m.blocked_reason
	if v == nil {
		return
	}
...
// OldBlockedReason returns the old "blocked_reason" field's value of the Domain entity.
// If the Domain object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *DomainMutation) OldBlockedReason(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *DomainMutation) ClearBlockedReason() {
	m.blocked_reason = nil
	m.clearedFields[domain.FieldBlockedReason] = struct{}{}
}

// BlockedReasonCleared returns if the "blocked_reason" field was cleared in this mutation.
func (m *DomainMutation) BlockedReasonCleared() bool {
	_, ok := m.clearedFields[domain.FieldBlockedReason]
	return ok
}

// ResetBlockedReason resets all changes to the "blocked_reason" field.
func (m *DomainMutation) ResetBlockedReason() {
	m.blocked_reason = nil
	delete(m.clearedFields, domain.FieldBlockedReason)
}
...
func (m *DomainMutation) Fields() []string {
	...
	if m.blocked_reason != nil {
		fields = append(fields, domain.FieldBlockedReason)
	}
	if m.created_at != nil {
...
func (m *DomainMutation) ClearedFields() []string {
	...
	if m.FieldCleared(domain.FieldBlockedReason) {
		fields = append(fields, domain.FieldBlockedReason)
	}
	return fields
}
...
// SetDomain sets the "domain" field.
func (m *RenewTaskMutation) SetDomain(s string) {
	m.domain = &s
}

// Domain returns the value of the "domain" field in the mutation.
func (m *RenewTaskMutation) Domain() (r string, exists bool) {
	v := m.domain
	if v == nil {
		return
	}
...
// OldDomain returns the old "domain" field's value of the RenewTask entity.
// If the RenewTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RenewTaskMutation) OldDomain(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDomain is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetDomain resets all changes to the "domain" field.
func (m *RenewTaskMutation) ResetDomain() {
	m.domain = nil
}
...
func (m *RenewTaskMutation) Fields() []string {
	fields := make([]string, 0, 8)
	if m.domain != nil {
		fields = append(fields, renewtask.FieldDomain)
	}
	if m.status != nil {
