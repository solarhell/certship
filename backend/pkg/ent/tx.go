...
func (tx *Tx) init() {
	tx.AppSettings = NewAppSettingsClient(tx.config)
	...
	tx.RenewTask = NewRenewTaskClient(tx.config)
...
// applies a query, for example: AppSettings.QueryXXX(), the query will be executed
