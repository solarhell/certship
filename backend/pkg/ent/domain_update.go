...
func (_u *DomainUpdate) SetBlockedReason(v string) *DomainUpdate {
	_u.mutation.SetBlockedReason(v)
	return _u
}

// SetNillableBlockedReason sets the "blocked_reason" field if the given value is not nil.
func (_u *DomainUpdate) SetNillableBlockedReason(v *string) *DomainUpdate {
	if v != nil {
...
func (_u *DomainUpdate) ClearBlockedReason() *DomainUpdate {
...
func (_u *DomainUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.BlockedReasonCleared() {
		_spec.ClearField(domain.FieldBlockedReason, field.TypeString)
	}
...
// SetBlockedReason sets the "blocked_reason" field.
func (_u *DomainUpdateOne) SetBlockedReason(v string) *DomainUpdateOne {
	_u.mutation.SetBlockedReason(v)
	return _u
}

// SetNillableBlockedReason sets the "blocked_reason" field if the given value is not nil.
func (_u *DomainUpdateOne) SetNillableBlockedReason(v *string) *DomainUpdateOne {
	if v != nil {
		_u.SetBlockedReason(*v)
	}
	return _u
...
// ClearBlockedReason clears the value of the "blocked_reason" field.
func (_u *DomainUpdateOne) ClearBlockedReason() *DomainUpdateOne {
	_u.mutation.ClearBlockedReason()
	return _u
}
