...
func init() {
	...
	appsettings.ScanIntervalValidator = func() func(string) error {
		validators := appsettingsDescScanInterval.Validators
	...
	// appsettings.RenewBeforeDaysValidator is a validator for the "renew_before_days" field. It is called by the builders before save.
	appsettings.RenewBeforeDaysValidator = func() func(int) error {
		validators := appsettingsDescRenewBeforeDays.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(renew_before_days int) error {
			for _, fn := range fns {
				if err := fn(renew_before_days); err != nil {
					return err
				}
			}
			return nil
	...
	authtokenDescUserID := authtokenFields[1].Descriptor()
	...
	// authtokenDescLoginUserAgent is the schema descriptor for login_user_agent field.
	authtokenDescLoginUserAgent := authtokenFields[3].Descriptor()
	// authtoken.LoginUserAgentValidator is a validator for the "login_user_agent" field. It is called by the builders before save.
	authtoken.LoginUserAgentValidator = authtokenDescLoginUserAgent.Validators[0].(func(string) error)
	// authtokenDescLoginIP is the schema descriptor for login_ip field.
	authtokenDescLoginIP := authtokenFields[4].Descriptor()
	// authtoken.LoginIPValidator is a validator for the "login_ip" field. It is called by the builders before save.
	authtoken.LoginIPValidator = authtokenDescLoginIP.Validators[0].(func(string) error)
	// authtokenDescLastActiveUserAgent is the schema descriptor for last_active_user_agent field.
	authtokenDescLastActiveUserAgent := authtokenFields[6].Descriptor()
	// authtoken.LastActiveUserAgentValidator is a validator for the "last_active_user_agent" field. It is called by the builders before save.
	authtoken.LastActiveUserAgentValidator = authtokenDescLastActiveUserAgent.Validators[0].(func(string) error)
	// authtokenDescLastActiveIP is the schema descriptor for last_active_ip field.
	authtokenDescLastActiveIP := authtokenFields[7].Descriptor()
	// authtoken.LastActiveIPValidator is a validator for the "last_active_ip" field. It is called by the builders before save.
	authtoken.LastActiveIPValidator = authtokenDescLastActiveIP.Validators[0].(func(string) error)
	...
	_ = renewtaskFields
	// renewtaskDescDomain is the schema descriptor for domain field.
	renewtaskDescDomain := renewtaskFields[1].Descriptor()
	// renewtask.DomainValidator is a validator for the "domain" field. It is called by the builders before save.
	renewtask.DomainValidator = renewtaskDescDomain.Validators[0].(func(string) error)
